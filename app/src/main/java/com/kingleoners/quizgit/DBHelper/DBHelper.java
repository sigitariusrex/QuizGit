package com.kingleoners.quizgit.DBHelper;
...
public class DBHelper extends SQLiteAssetHelper {
    ...
    private static final String DB_NAME = "Tes7.db";
    ...
    /*
    Get 20 question from db by category
     */
    public List<Question> getQuestionByCategory(int category)
    {
        SQLiteDatabase db = instance.getWritableDatabase();

        Cursor cursor = db.rawQuery(String.format("SELECT * FROM Question WHERE CategoryID = %d ORDER BY RANDOM() LIMIT 20;",category),null);
